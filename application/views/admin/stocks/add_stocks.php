...
<h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Add New Stokes</h3>
</div>
...
<div class="col-lg-10">
 <form action="<?php echo base_url() ?>dcadmin/stocks/add_stocks_data/<? echo base64_encode(1); ?>" method="POST" id="slide_frm" enctype="multipart/form-data">
...
<tr>
              ...
              <td>
<input type="text" name="name" id="stockName"  class="form-control" placeholder="" required value="" />
            </td>
</tr>
<tr>
              <td> <strong>Logo</strong>  <span style="color:red;">*</span></strong> </td>
              <td>
<input type="text" name="logo" id="formattedStock" class="form-control" placeholder="" required value="" />
            </td>
</tr>
<tr>
              <td> <strong>Price</strong>  <span style="color:red;">*</span></strong> </td>
              <td>
<input type="text" name="price" id="price" class="form-control" placeholder="" required value="" disabled/>
            </td>
</tr>
<tr>
