...
class Apicontroller extends CI_finecontrol
{
    ...
    public function get_buycall()
    {
      ...
      $this->db->select('*');
                ...
                $get_present_price =  $this->get_price(STOCKBNCE);
              //   //WILL SELL OLD ORDER
              $sell_old_order =  $this->database(2,1,QTY,STOCKBNCE,$get_present_price,"","");
              if($sell_old_order){
                echo "success";
                exit;
              }
                ...
                exit;
                    ...
                    //NO PENDING ORDERS
                      $get_present_price =  $this->get_price(STOCKBNCE);
                      echo $get_present_price;
                        $buy_order =  $this->database(2,1,QTY,STOCKBNCE,$get_present_price,"");
 ...
 $auth_code = $this->auth_code();
      ...
      $this->db->select('*');
                ...
                // GET NEW PRICE OF PE AND PLACE PE ORDER
                $get_present_price =  $this->get_price(STOCKBNPE);
              //   //WILL SELL OLD ORDER
              $sell_old_order =  $this->database(2,2,QTY,STOCKBNPE,$get_present_price,"","");
              if($sell_old_order){
                echo "success";
                exit;
              }
                ...
                exit;
                    ...
                    //NO PENDING ORDERS
                      $get_present_price =  $this->get_price(STOCKBNPE);
                        $buy_order =  $this->database(2,2,QTY,STOCKBNPE,$get_present_price,"");
